...
export function Sidebar({ setContactSelected, contato }: SidebarProps) {
    ...
    return (
        <div className="flex flex-col gap-2 w-150 bg-zinc-800 text-white p-4 border-r-1 border-zinc-600">
            <h1 className="text-2xl font-semibold">AppWhats</h1>
            ...
            <div className="flex flex-col gap-1 overflow-y-auto">
                {contatosUnicos
                    ...
                    .map(msg => (
                        <div className={`flex gap-3 p-2 rounded-lg hover:bg-zinc-700 ${contato === msg.contato ? 'bg-zinc-700' : 'bg-zinc-800'} cursor-pointer items-center`} key={msg.key} onClick={(e) => setContactSelected(msg.contato)}>
